...
public partial struct BuildCharacterPredictedRotationSystem : ISystem
{
    ...
    {
        state.RequireForUpdate(SystemAPI.QueryBuilder().WithAll<LocalTransform, FirstPersonCaharacterComponent>()
            .Build());
    }
    ...
    {
        void Execute(ref LocalTransform localTransform, in FirstPersonCaharacterComponent characterComponent)
        {
            FirstPersonCharacterUtilities.ComputeRotationFromYAngleUp(characterComponent.CharacterYDegrees,
...
public partial struct BuildCharacterInterpolatedRotationSystem : ISystem
{
    ...
    public void OnCreate(ref SystemState state)
    {
        state.RequireForUpdate(SystemAPI.QueryBuilder().WithAll<LocalTransform, FirstPersonCaharacterComponent>().Build());
    }
    [BurstCompile]
    public void OnUpdate(ref SystemState state)
    {
        var job = new BuildCharacterInterpolatiedRotationJob
        {
    ...
    public partial struct BuildCharacterInterpolatiedRotationJob : IJobEntity
    {
        public ComponentLookup<LocalTransform> LocalTransformLookup;

        void Execute(Entity entity, in FirstPersonCaharacterComponent characterComponent)
        {
            if(LocalTransformLookup.TryGetComponent(entity, out var characterLocalTransform))
            {
                ...
                {
                    viewLocalTransform.Rotation = FirstPersonCharacterUtilities.CalculateLocalViewRotation(
...
public partial struct FirstPersonCharacterPhysicsUpdateSystem : ISystem
{
    ...
    FirstPersonCharacterUpdateContex m_Context;
    ...
    public void OnCreate(ref SystemState state)
    {
        m_CharacterQuery = KinematicCharacterUtilities.GetBaseCharacterQueryBuilder()
            ...
            FirstPersonCharacterControl>().Build(ref state);

        m_Context = new FirstPersonCharacterUpdateContex();
    ...
    {
        public FirstPersonCharacterUpdateContex Context;
...
public partial struct FirstPersonCharacterVariableUpdateSystem : ISystem
{
    ...
    public void OnCreate(ref SystemState state)
    {
        m_CharacterQuery = KinematicCharacterUtilities.GetBaseCharacterQueryBuilder()
            .WithAll<
                FirstPersonCaharacterComponent,
    ...
    public void OnUpdate(ref SystemState state)
    {
        ...
        {
            FirstPersonCharacterLookup = SystemAPI.GetComponentLookup<FirstPersonCaharacterComponent>(true),
        };
    ...
    {
        [ReadOnly]
        public ComponentLookup<FirstPersonCaharacterComponent> FirstPersonCharacterLookup;
...
public partial struct FirstPersonCharacterPresentationOnlySystem : ISystem
{
    ...
    public partial struct FirstPersonCharacterViewRollJob : IJobEntity
    {
        ...
        void Execute(Entity entity, ref FirstPersonCaharacterComponent characterComponent,
