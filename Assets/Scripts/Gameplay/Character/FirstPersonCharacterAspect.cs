...
using Unity.Physics;
using Unity_NetCode_Generated_Unity_NetCode;
using UnityEngine;

public struct FirstPersonCharacterUpdateContex
{
...
public readonly partial struct FirstPersonCharacterAspect : IAspect, 
    IKinematicCharacterProcessor<FirstPersonCharacterUpdateContex>
{
    readonly KinematicCharacterAspect m_CharacterAspect;
    readonly RefRW<FirstPersonCaharacterComponent> m_CharacterComponent;
    readonly RefRW<FirstPersonCharacterControl> m_CharacterControl;
    readonly RefRW<ActiveWeapon> m_ActiveWeapon;

    public void PhysicsUpdate(ref FirstPersonCharacterUpdateContex context, ref KinematicCharacterUpdateContext baseContext)
    {
        ...
        //Update desired character velocity after grounding was detected and before doing additional  processing depending on velocity
        ...
        m_CharacterAspect.Update_MovementAndDecollisions(in this, ref context, ref baseContext, ref characterBody, ref characterPosition);
    ...
    void HandleVelocityControl(ref FirstPersonCharacterUpdateContex context, ref KinematicCharacterUpdateContext baseContext)
    {
        ...
        else
        {
            ...
            if (math.lengthsq(airAcceleration) > 0f)
            {
                ...
                characterComponent.AirMaxSpeed, characterBody.GroundingUp, deltaTime, true);
                //Cancle air acceleration from unput if non ground surface hit
                if (characterComponent.PreventAirAccelerationAgainstUngroundedHits &&
                    m_CharacterAspect.MovementWouldHitNonGroundedObstruction(in this,
               ref context,ref baseContext, characterBody.RelativeVelocity * deltaTime, out _))
    ...
    public void VariableUpdate(ref FirstPersonCharacterUpdateContex context,
    ...
    public void UpdateGroundingUp(
           ref FirstPersonCharacterUpdateContex context,
           ref KinematicCharacterUpdateContext baseContext)
    {
        ref var characterBody = ref m_CharacterAspect.CharacterBody.ValueRW;
