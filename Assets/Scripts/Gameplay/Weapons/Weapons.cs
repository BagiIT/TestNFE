...
public enum RaycastWeaponVisualSyncMode
{
    Precise,
    BandwithEfficient,
}
...
{
    public Entity ProjecttilePrefab;
...
public struct WeaponProjectileEvent : IBufferElementData
{
    ...
    public float3 VisualPosiion;
    public float3 SimulationDirection;
}

[GhostComponent(OwnerSendType = SendToOwnerType.SendToNonOwner)]
public struct RaycastWeaponVisualProcjetileEvent : IBufferElementData
{
    [GhostField]
    public uint Tick;
    [GhostField]
